...
for x in pycountry.countries:
    ...
    LOCATIONS.append(x.alpha_3.lower())
...
# MODEL = Word2Vec.load_word2vec_format("model3.dat", binary=True, unicode_errors='ignore')
...
if __name__ == "__main__":
    ...
    for pdf in listdir('big_dataset'):
        print "%s: []," % repr(pdf)
    for pdf in listdir('big_dataset'):
        ...
        pdf_id += 1
        try:
            text = convert_pdf_to_text('big_dataset/'+pdf)
#            print text
        except:
            continue
        try:
